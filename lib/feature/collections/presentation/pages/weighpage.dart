...
//                       ),
//                       // ElevatedButton(
//                       //   onPressed: deviceStatus == MyDevice.connected
//                       //       ? () async {
              ...
              children: <Widget>[
                ...
                Consumer<WeightNotifier>(
                  builder: (context, notifier, child) {
                    return Row(
                      children: [
                        const Text('Stable: ', style: TextStyle(fontSize: 16)),
                        Icon(
                ...
                Row(
                  ...
                  children: [
                    ElevatedButton(
                      ...
                      onPressed:
                          weightNotifier.isStable ? _confirmWeight : null,
                      child: const Text('Confirm Weight', style: TextStyle()),
                    ),
                    const Spacer(),
                    Text(
                      'Stable: $_stableWeight KG',
